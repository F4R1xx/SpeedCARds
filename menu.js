        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="glass-panel my-4 flex justify-between items-center flex-wrap gap-4 p-4">
                ...
                <div class="flex items-center gap-2 md:gap-4 flex-wrap justify-end">
                    ...
                    <!-- Botão Amigos -->
                    <button class="flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-bold px-3 py-2 rounded-lg transition-colors" title="Amigos">
                    ...
                    <!-- Botão Comprar Ouro -->
                    <button class="flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-bold px-3 py-2 rounded-lg transition-colors" title="Comprar Ouro">
